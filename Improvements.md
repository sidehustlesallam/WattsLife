...
- [ ] **Shareable System Specs (URL Hash Encoding):**
...
- [ ] **Dynamic Temperature / Seasonal Slider:**
...
- [ ] **Turbine Cut-in Wind Speed Logic:**
...
- [ ] **Interactive Footprint Visualizer (SVG Canvas):**
...
- [ ] **"Days of Autonomy" Survival Simulator:**
...
- [ ] **Off-Grid Appliances Equivalent Breakdown:**
...
- [ ] **Theme Customization (Dark / High Contrast Solar Mode):**
